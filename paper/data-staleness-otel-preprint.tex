...
standardized metrics, and an OpenTelemetry Collector processor that centrally
derives age and evaluates freshness SLAs. Third, we evaluate the
...
the Collector. Our aim is not a new freshness metric but the
