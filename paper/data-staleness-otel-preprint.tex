...
change. Additional first-party probes and source types (BigQuery and Snowflake
...
language-agnostic conformance suite, the Python SDK (\texttt{otel-staleness}),
...
deployments, and benchmarks are released as open source under Apache-2.0.
